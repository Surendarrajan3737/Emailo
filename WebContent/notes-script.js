...
function createNote(){
  ...
  node1.setAttribute("style", "width:200px; height:200px; font-size:26px; padding:15px; margin-top:10px; overflow-wrap: break-word; box-shadow: 0px 10px 24px 0px rgba(0,0,0,0.75)")
